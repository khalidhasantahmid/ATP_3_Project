...
<body>
    ...
    <section class="single_product_details_area d-flex align-items-center">
        ...
        <div class="single_product_desc clearfix">
            ...
            <!-- Form -->
            <form class="form" method="post" action="<?php echo e(route('singleview.postCart', ['id' => $product['id'], 'action' => 'add'])); ?>"> 
                ...
                <input type="hidden" name="hidden_image" value="<?php echo e($product['path']); ?>" />
