        ...
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
                    ...
                    <div class="classynav">
                        <ul>
                            ...
                            <?php if($loggedUser != null): ?>
                                <li><a href="<?php echo e(route('logout')); ?>" style="color: red;">Logout</a></li>
                            <?php else: ?>
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <div class="user-login-info">
                    ...
                    <?php if($loggedUser != null): ?>
                        <a href="<?php echo e(route('home')); ?>"><?php echo e($loggedUser->name); ?></a>
                    <?php else: ?>
...
<div class="container" style="margin-top: 2%; width: 80%;">
    ...
    <div id="Add_Product" class="tabcontent" >
        <div class="col-12">
            <form name="addProduct" action="<?php echo e(route('home.addProduct')); ?>" method="post" id="product_detail">
    ...
    <div id="User_Info" class="tabcontent" >
        ...
        <form action="<?php echo e(route('home.updateUserInfo')); ?>" id="infoForm" method="post" style="width: 60%; margin-left: 20%;">
            <div class="row">
                <div class="col-md-12 mb-3">
                    <label for="name">Name <span>*</span></label>
                    <input type="text" class="form-control" id="name" name="cName" value="<?php echo e($loggedUser->name); ?>" required>
                </div>
                <div class="col-12 mb-3">
                    <label for="pNumber">Phone No <span>*</span></label>
                    <input type="number" class="form-control" id="pNumber" name="pNumber" min="0" value="<?php echo e($loggedUser->phone); ?>" required>
                </div>
                <div class="col-12 mb-4">
                    <label for="email">Email Address <span>*</span></label>
                     <input type="email" class="form-control" id="email" name="email" value="<?php echo e($loggedUser->email); ?>" required>
                </div>
                <div class="col-md-12 mb-3">
    ...
    <div id="Order_List" class="tabcontent" >
        ...
        <div class="col-12 mb-3" align="center">
            ...
            <a href="<?php echo e(route('print.orders')); ?>" class="btn essence-btn" id='printO'>Print</a></center>
        ...
        <table class="sTable">
            ...
            <tr>
                ...
                <td width="10%"><?php echo e($order->cartId); ?></td>
                <td width="20%"><?php echo e($order->date); ?></td>
                <td width="5%"><?php echo e($order->cost); ?></td>
                <td width="20%"><?php echo e($order->address); ?></td>
                <td width="15%"><?php echo e($order->cEmail); ?></td>
                <td width="10%">
                    <a href="<?php echo e(route('home.orderStatus', ['id' => $order->id])); ?>" style="color: green;">Change</a> | 
                    <a href="<?php echo e(route('home.orderDelete', ['id' => $order->id])); ?>" style="color: red;">Delete</a>
                </td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
    ...
    <div id="Product_Info" class="tabcontent" >
        <?php if($products != null): ?>
                <div class="col-12 mb-3" align="center">
                    ...
                    <a href="<?php echo e(route('print.products')); ?>" class="btn essence-btn" id='printP'>Print</a></center>
                </div>
        <table class="sTable">
            <tr>
            ...
            <tr>
                ...
                <td width="5%"><?php echo e($product->price); ?></td>
                <td width="15%"><?php echo e($product->description); ?></td>
                <td width="20%"><img src="/assets/img/<?php echo e($product->path); ?>"></td>
                <td width="15%"><?php echo e($product->addedDate); ?></td>
                <td width="15%"><?php echo e($product->addedBy); ?></td>
                <td width="10%">
                    <a href="<?php echo e(route('home.editProduct', ['id' => $product->id])); ?>" style="color: green;">Edit</a> | 
                    <a href="<?php echo e(route('home.deleteProduct', ['id' => $product->id])); ?>" style="color: red;">Delete</a>
                </td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
            ...
            <?php else: ?>
                <div class="col-12">
                    <form name="addProduct" action="<?php echo e(route('home.updateProduct')); ?>" method="post" id="product_detaill">
                        <?php echo e(csrf_field()); ?>
                        ...
                        <table>     
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="ppName" style="width: 200px;" value="<?php echo e($product->name); ?>" required>
                                </td>
                                <td rowspan="4">
                                    <img src="/assets/img/<?php echo e($product->path); ?>" id="profile-img-tag" width="200px" name="pic"/>
                                </td>
                            </tr>
                            <tr>
                                <td>Product price :<br><br></td>
                                <td>
                                    <input type="number" name="ppPrice" min="0" max="5000" style="width: 80px;" value="<?php echo e($product->price); ?>" required><br><br>
                                </td>
                            </tr>
                            <tr>
                                <td>Product Tags :<br><br></td>
                                <td>
                                    <input type="text" name="ppTag" style="width: 200px;" value="<?php echo e($product->tag); ?>" required><br><br>
                                </td>
                            </tr>
                            <tr>
                                <td>Product Detail :<br><br><br><br><br></td>
                                <td>
                                    <textarea rows="4" cols="40" name="ppDetail" form="product_detaill" value="" required><?php echo e($product->description); ?></textarea>
                                    <br><br>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    ...
                                    <a href="<?php echo e(route('home.deleteProduct', ['id' => $product->id])); ?>" class="btn essence-btn" style="margin-left: 10%;"> Delete</a>
                                </td>
                            </tr>
                        </table>
                    </form> 
    ...
    <div id="User_List" class="tabcontent" >
        ...
        <div class="col-12 mb-3" align="center">
            ...
            <a href="<?php echo e(route('print.users')); ?>" class="btn essence-btn" id='printU'>Print</a></center>
        </div>
        ...
        <table class="sTable">
            ...
            <tr>
                <td width="5%"><?php echo e($user->id); ?></td>
                <td width="25%"><?php echo e($user->name); ?></td>
                <td width="20%"><?php echo e($user->phone); ?></td>
                <td width="25%"><?php echo e($user->email); ?></td>
                <td width="15%"><?php echo e($user->type); ?></td>
                <td width="10%">
                    <a href="<?php echo e(route('home.deleteUser', ['id' => $user->id])); ?>" style="color: red;">Delete</a>
                </td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
    ...
    <div id="Sales_report" class="tabcontent" >
        ...
        <div class="col-12 mb-3" align="center">
            ...
            <br>
            <a href="<?php echo e(route('print.profit')); ?>" class="btn essence-btn" id='printF'>Print</a></center>
        </div>
