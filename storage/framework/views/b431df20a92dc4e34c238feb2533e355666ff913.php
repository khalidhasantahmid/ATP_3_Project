...
<div class="container" style="margin-top: 2%; width: 40%;">
    ...
    <form method="post" action="<?php echo e(route('registration.register')); ?>">
        <?php echo e(csrf_field()); ?>

        <div class="row">
            <div class="col-md-12 mb-3">
                <label for="name">Name <span>*</span></label>
                <input type="text" class="form-control" id="cName" name="name" value="<?php echo e(old('name')); ?>" >
            </div>
            <div class="col-12 mb-3">
                <label for="pNumber">Phone No <span>*</span></label>
                <input type="number" class="form-control" id="cPhone" name="number" min="0" value="<?php echo e(old('number')); ?>">
            </div>
            <div class="col-12 mb-4">
                <label for="email">Email Address <span>*</span></label>
                 <input type="email" class="form-control" id="cEmail" name="email" value="<?php echo e(old('email')); ?>">
            </div>
            <div class="col-md-12 mb-3">
            ...
            <div class="col-md-12 mb-3">
                <input type="submit" class="btn essence-btn" style="width: 100%;" value="Register">
                <br><br>
                <input type="reset" class="btn essence-btn" id="reset" style="width: 100%;" value="Clear">
            </div>
        </div>
    </form>
