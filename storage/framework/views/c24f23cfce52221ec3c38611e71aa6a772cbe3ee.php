...
<div class="container" style="margin-top: 8%; width: 80%;">
    <form method="post" action="<?php echo e(route('cart.placeOrder')); ?>">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-md-offset-1">
                   ...
                   <tr>
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('singleview.getCart', ['id' => $values['item_id'], 'action' => 'delete'])); ?>"><span class="text-danger">Remove</span></a></td>
                        </tr>
                        <?php
               ...
               <?php if($loggedUser != null && $loggedUser['type'] != 'admin' && isset($_SESSION["shopping_cart"])): ?>
