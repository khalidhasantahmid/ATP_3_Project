                                ...
                                <ul id="menu-content2" class="menu-content collapse show">
                                    ...
                                    <li data-toggle="collapse" data-target="#clothing">
                                        ...
                                        <ul class="sub-menu collapse show" id="clothing">
                                            <li><a href="<?php echo e(route('gallery.searchByTag', ['term' => 'Char'])); ?>">Charecter</a></li>
                                            <li><a href="<?php echo e(route('gallery.searchByTag', ['term' => 'Bang'])); ?>">Bangla</a></li>
                                            <li><a href="<?php echo e(route('gallery.searchByTag', ['term' => 'Quot'])); ?>">Quotes</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="product-topbar d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="total-products">
                                        <p><span><?php echo e($countP); ?></span> products found</p>
                                    </div>
                                    <!-- Sorting -->
                                    <div class="product-sorting d-flex">
                                        <p>Sort by:</p>
                                            <select name="select" id="sortByselect" onChange="window.location.href=this.value"> 
                                                ...
                                                <option value="<?php echo e(route('gallery.sort', ['term' => 'desc'])); ?>">Price (High - Low)</option>
                                                <option value="<?php echo e(route('gallery.sort', ['term' => 'asc'])); ?>">Price (Low - High)</option>
                                            </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-wrapper">
                                    ...
                                    <div class="product-img">
                                        <img src="/assets/img/<?php echo e($product->path); ?>" alt="">
                                        <!-- Hover Thumb -->
                                        <img class="hover-img" src="/assets/img/<?php echo e($product->path); ?>" style="" alt="">
                                        <!-- Product Badge -->
                                    ...
                                    <div class="product-description">
                                        ...
                                        <a href="<?php echo e(route('singleview', ['id' => $product->id])); ?>">
                                        ...
                                        <div class="hover-content">
                                            ...
                                            <div class="add-to-cart-btn">
                                                <a href="<?php echo e(route('singleview', ['id' => $product->id])); ?>" class="btn essence-btn">View</a>
                                            </div>
                                        </div>
