    ...
    <form method="post" action="{{route('registration.register')}}">
        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control" id="cName" name="name" value="{{ old('name') }}" >
            </div>
            <div class="col-12 mb-3">
                <label for="pNumber">Phone No <span>*</span></label>
                <input type="number" class="form-control" id="cPhone" name="number" min="0" value="{{ old('number') }}">
            </div>
            <div class="col-12 mb-4">
                <label for="email">Email Address <span>*</span></label>
                 <input type="email" class="form-control" id="cEmail" name="email" value="{{ old('email') }}">
            </div>
            <div class="col-md-12 mb-3">
